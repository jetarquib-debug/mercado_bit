...
SECRET_KEY = 'django-insecure-#1x%zntu3ekbo8m8f=0r%gop&x-&aollip7d_%hc^)7zph=)5x'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'usuario.context_processors.usuario_actual',
                'barra_market.context_processors.global_nav',
            ],
        },
    },
]
