...
class APIFilterPaginationTests(APITestCase):
    def setUp(self):
        # Crear datos básicos
    ...
    def test_product_search_and_ordering(self):
        ...
        self.assertEqual(resp.status_code, 200)
        data = resp.json()
        # using limit-offset, may have results key
        results = data.get('results', data)
        # first result should contain 'Zapato' and have highest precio among matches
